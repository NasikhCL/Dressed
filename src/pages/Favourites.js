    ...
    <div>
      ...
      <h1 className='text-2xl font-bold my-5 px-7'>My Favourites</h1>
       ...
       { isComplete ? (( myFavs && (myFavs.length !== 0) ) ? myFavs.map(item =>{  
            return ( 
                <div key={item.id} className="border rounded-lg shadow-md max-w-sm mt-7 mx-1 ">
                    <div className='h-96'>
                        <img
                    ...
                    <div className="p-4">
                        <div className='flex justify-between'>
                            ...
                            <button onClick={()=> handleRemoveClick(item.id)}>
                                <h4 className='text-red-500 text-2xl cursor-pointer'><i className="fa-solid fa-heart"></i></h4>
                            </button>
