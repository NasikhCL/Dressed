    ...
    <div  className='h-fit mb-141'>
        ...
        <div  className='flex  flex-col lg:flex-row justify-between items-center '>
            ...
            <div className='lg:w-2/4 flex flex-col   justify-between items-center px-7 lg:px-14'>
                <h2 className='mb-4 text-2xl font-bold italic text-center '>TEAM Enosh & Anand</h2>
                <p className='text-center text-gray-800 mb-7'>We are a group of Students who aim at creating a better future with the help of computer science and technology </p>
